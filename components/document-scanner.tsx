...
export function DocumentScanner({ onSave, scannedDocs, onDelete }: DocumentScannerProps) {
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select value={category} onValueChange={(value: ScanDocument["category"]) => setCategory(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          {scannedPages.length > 0 && (
            <div>
              <label className="text-sm font-medium mb-2 block">Scanned Pages ({scannedPages.length})</label>
